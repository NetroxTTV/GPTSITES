const sites = [
    ...
    {name: "SplitDrop", url: "https://splitdrop.com/friend/74388", logo: "imgs/splitdrop.png", featured: true, rates: "", offerwalls: ["myChips", "ayet", "torox", "hangmyads", "adtowall", "adgate", "mmwall", "notik", "monlix", "adscend", "lootably", "timewall", "revu"]},
    {name: "GameHag", url: "https://gamehag.com/r/netrox", logo: "imgs/gamehag.png", featured: true, rates: "", offerwalls: ["revu", "torox", "lootably", "ayet", "myChips", "adscend", "timewall"]},
    {name: "KashRewards", url: "https://kashrewards.com/?a=383", logo: "imgs/kashrewards.ico", featured: true, rates: "", offerwalls: ["lootably", "monlix", "ayet", "notik", "adtowall", "timewall"]},
    {name: "GG2U", url: "https://premium.gg2u.org/?referrer=netroxtv", logo: "imgs/gg2u.png", featured: true, rates: ""},
    {name: "Freeward", url: "https://freeward.net/ref/lom3w", logo: "imgs/freeward.png", featured: true, rates: "", offerwalls: ["torox", "ayet", "adtowall", "mmwall", "lootably", "waxrewards", "myChips", "monlix", "adscend", "revu", "notik", "timewall"]},
    {name: "Earnut", url: "https://earnut.com/?r=NetroxTV", logo: "imgs/earnut.webp", featured: true, rates: ""},
    {name: "CashHut", url: "https://cashhut.net/ref/L7TLOG", logo: "imgs/cashhut.png", featured: true, rates: "", offerwalls: ["ayet", "adtowall", "lootably", "waxrewards", "notik", "timewall"]},
    ...
    {name: "WeCash", url: "https://wecash.one?inviteCode=iEnuXi6cT7MyzTUqGuqp", logo: "imgs/wecash.png", featured: true, rates: "", offerwalls: ["torox", "ayet", "adgate", "lootably", "adscend", "mmwall", "timewall", "monlix", "notik", "myChips"]},
    {name: "Earnably", url: "https://earnably.com/join/3079623", logo: "imgs/earnably.png", featured: true, rates: ""},
    {name: "GaintPlay", url: "https://gaintplay.com/refer/netrix", logo: "imgs/gaintplay.png", featured: true, rates: "", offerwalls: ["torox", "adgem", "adscend", "lootably", "hangmyads", "revu", "notik", "timewall"]},
